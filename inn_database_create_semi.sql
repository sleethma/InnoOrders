...
create table orders (id bigint not null auto_increment, build_date date, property_address varchar(255), resident_first_name varchar(255), resident_last_name varchar(255), owner_id bigint, type_id bigint, primary key (id)) engine=InnoDB;
create table customers (id bigint not null auto_increment, first_name varchar(255), last_name varchar(255), address varchar(255), city varchar(255), telephone varchar(255), primary key (id)) engine=InnoDB;
...
alter table homes add constraint FKe24b9dswnm8p4pgxkotcdekp4 foreign key (owner_id) references customers (id);
alter table homes add constraint FK9hch2hk5ndcy22fp7bm0ri78s foreign key (type_id) references plan_types (id);
alter table repairs add constraint FK7bbq9uujk5y03kwe7fsqg53do foreign key (home_id) references orders (id);
